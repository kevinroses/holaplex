...
export function CardGridWithHeader<T, F = null>(props: CardGridWithHeaderProps<T, F>): JSX.Element {
  ...
  return (
    <div className="w-full space-y-4 text-base">
      <div className="nftheadercarrousell sticky top-0 z-10 flex w-full flex-col items-center gap-6 bg-gray-900 bg-opacity-80 py-4 backdrop-blur-sm lg:flex-row lg:justify-between lg:gap-4">
